...
%>
       ...
       <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
        ...
        <li class="dropdown-header"><fmt:message key="jsp.layout.navbar-default.browseitemsby"/></li>
          ...
          <li class="<%= ( currentPage.endsWith( "/help" ) ? "active" : "" ) %>"><a target="_blank" href="/repositorio/help/Manual.pdf">Ayuda</a> </li>
       </ul>
 ...
 %>
	...
	<form method="get" action="<%= request.getContextPath() %>/simple-search" class="navbar-form navbar-right">
	    <div class="form-group">
          <input type="text" class="form-control" placeholder="Búsqueda Avanzada" name="query" id="tequery" size="25"/>
        </div>
